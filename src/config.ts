...
const PROJECT_TYPES = ["Vanilla", "React", "Express"] as const;

export const pathPrompt: QuestionCollection = {
  type: "input",
  name: "projectPath",
  prefix: "Path: ",
...
export const projectTypePrompt: QuestionCollection = {
  type: "list",
  name: "projectType",
  prefix: "Project type:",
...
export const projectNamePrompt: QuestionCollection = {
  type: "input",
  prefix: "Project name: ",
  name: "projectName",
